        ...
        <x-section>
            <x-table>
                <x-table.columns>
                    ...
                    <x-table.column wire:click="sort('first_brewed_at')" sortable :sorted="$sortBy === 'first_brewed_at'"
                        :direction="$sortDirection">Data da primeira receita</x-table.column>

                    <x-table.column wire:click="sort('abv')" sortable :sorted="$sortBy === 'abv'"
                        :direction="$sortDirection">Abv</x-table.column>

                    <x-table.column wire:click="sort('ibu')" sortable :sorted="$sortBy === 'ibu'"
                        :direction="$sortDirection">Ibu</x-table.column>

                    <x-table.column wire:click="sort('ebc')" sortable :sorted="$sortBy === 'ebc'"
                        :direction="$sortDirection">Ebc</x-table.column>

                    <x-table.column wire:click="sort('ph')" sortable :sorted="$sortBy === 'ph'"
                        :direction="$sortDirection">Ph</x-table.column>

                    <x-table.column wire:click="sort('volume')" sortable :sorted="$sortBy === 'volume'"
                        :direction="$sortDirection">Volume</x-table.column>
            ...
            <div class="mt-6">{{ $beers->links() }}</div>
        </x-section>
    </flux:main>
</div>
